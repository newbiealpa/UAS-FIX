...
<body>
    ...
    <header class="py-5 bg-image-full" style="background-image: linear-gradient(rgb(15, 68, 114), black)">
        <div class="text-center my-5">
            <img class="img-fluid rounded-circle mb-4" src="../BOOTSTRAP-BOOTCAM/assets/webpunya.png" alt="..." />
            <h1>
                <span class="text-primary">DIVISI WEBSITE SIRIL COMMUNITY</span>
            </h1>
            <h6 class="text-white-50 mb-0">Web Division, Our Digital Frontier.</h6>
            <div class="container my-5">
                <div class="row justify-content-center">
                    <div class="col-lg-10 text-center">
                        <p class="lead text-light">
                            Divisi Website dalam komunitas SIRIL menjadi salah satu pondasi penting dalam membangun
                            identitas digital dan memfasilitasi interaksi antara komunitas dengan anggota. Divisi
                            ini bertanggung jawab untuk pengembangan, pemeliharaan, dan pengoptimalan website resmi
                            SIRIL Community
                            serta memberikan materi yang berkaitan dengan Web Development.

                            Program kinerja di divisi website mencakup beberapa inisiatif yang bertujuan untuk
                            meningkatkan kualitas
                            layanan dan pengalaman anggota. Salah satunya adalah pengembangan konten informatif dan
                            edukatif tentang
                            teknologi, baik melalui artikel, tutorial, maupun sumber daya belajar lainnya. Dengan
                            demikian, website
                            menjadi sumber referensi yang berharga bagi mahasiswa IT dan masyarakat umum yang tertarik
                            dengan
    ...
    <section id="instructors" class="p-5 bg-primary"
        style="background-image: linear-gradient( black, rgb(255, 208, 0))">
        <div class="container">
